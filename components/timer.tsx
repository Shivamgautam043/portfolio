    ...
    return (
        <div className="relative h-[50vh] w-full overflow-hidden">
            <div className="absolute top-[50%] w-full grid translate-y-[-28px] grid-flow-col gap-6 place-content-center place-items-start ">
                ...
                <div
                    className={`relative bg-gray-700 rounded-md transition-all duration-500`}
                    style={{
                        transform: translateValue(
                            10,
            ...
            <div className="absolute top-[50%] w-full grid translate-y-[-28px] grid-flow-col gap-6 place-content-center place-items-center ">
                {[...Array(6)].map((item, index) => (
                    <div
                        key={index}
                        className={`bg-[rgba(237,233,233,0.27)] z-30 rounded-full transition-all duration-500 scale-125 aspect-square !w-[42px] !h-[42px] mt-2`}
                    >
                        <div className="grid grid-cols-1 ">
                            <div className="p-4">
